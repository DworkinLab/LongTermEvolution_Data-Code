...
```{r}
man.mod <- lm(activity_counts ~ Treatment + hour + monitor + day,data=Mantid_hour)
...
```{r}
man_mod_2 <- gls(activity_counts ~ Treatment + hour + monitor + day, correlation = corAR1(form = ~ 1|hour), data=Mantid_hour)
...
```{r}
man_mod_3 <- gls(activity_counts ~ Treatment + light + light:Treatment +  hour + monitor + day, correlation = corAR1(form =~1|hour), control = list(singular.ok = TRUE), data=Mantid_hour)
...
```{r}
Exp2_mod <- lm(activity_counts ~ Treatment + hour + monitor + day,data=Exp2_hour)
...
```{r}
Exp2_mod_2 <- gls(activity_counts ~ Treatment + hour + monitor + day, correlation = corAR1(form = ~ 1|hour), data=Exp2_hour)
...
```{r}
Exp2_mod_3 <- gls(activity_counts ~ Treatment + light + light:Treatment +  hour + monitor + day, correlation = corAR1(form =~1|hour), control = list(singular.ok = TRUE), data=Exp2_hour)
...
```{r}
exp3.mod_2 <- gls(activity_counts ~ Treatment + hour + monitor + day, correlation = corAR1(form = ~ 1|hour), data=Exp3_hour)
...
```{r}
exp3.mod_3 <- gls(activity_counts ~ Treatment + light + light:Treatment +  hour + monitor + day, correlation = corAR1(form =~1|hour), control = list(singular.ok = TRUE), data=Exp3_hour)
